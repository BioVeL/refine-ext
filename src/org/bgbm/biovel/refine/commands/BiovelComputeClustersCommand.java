...
import org.bgbm.biovel.refine.clustering.scientificname.ScientificNameClusterer;
...
public class BiovelComputeClustersCommand extends Command {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("sciname".equals(type)) {
                clusterer = new ScientificNameClusterer();
            } 
